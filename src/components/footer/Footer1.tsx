...
const navigation = {
  ...
  faqs: [
    { name: 'Worlds', href: 'https://www.backstory.ink/faq/worlds', target: "_self" },
    { name: 'Stories', href: 'https://www.backstory.ink/faq/stories', target: "_self" },
    { name: 'Sales', href: 'https://www.backstory.ink/faq/sales', target: "_self" },
  ],
