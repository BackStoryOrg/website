  ...
  return (
    <div className="bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <p className="text-base font-semibold leading-7 text-indigo-600">Canons, lore and then some</p>
        <h2 className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Building</h2>
...
export function BuildingContent1() {
  return (
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          <p className="text-base font-semibold leading-7 text-indigo-600">No more heavy lifting</p>
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">We build the macro</h1>
          <div className="mt-10 grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-gray-700 lg:max-w-none lg:grid-cols-2">
            ...
            <div>
              <p>
                Here at Backstory we&apos;ve developed our unique <b>World Building Engine</b>. We have designed it to be able to create a fictional world with all the elements you would expect to see. We took it a step further and trained our engine to programmatically build a world&apos;s history without any inconsistencies. Our engine can build a world as rich and detailed as Tolkien&apos;s Arda in less than a week.
              </p>
              <p className="mt-8">
                With each world we create at Backstory, we handle the macro programmatically. We then recruit creatives into a world&apos;s team as <b>builders</b>, to fill in the micro. By shortening the time it takes to build a world down to 1 week, we dramatically increase the chance of that world&apos;s success. Quicker turn arounds lead to more opportunities for consumer engagement.
              </p>
            </div>
          </div>
        </div>
...
export function BuildingContent2() {
  return (
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          <p className="text-base font-semibold leading-7 text-indigo-600">Just another know-it-all</p>
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Being a loremaster</h1>
          <div className="mt-10 grid max-w-xl grid-cols-1 gap-8 text-base leading-7 text-gray-700 lg:max-w-none lg:grid-cols-2">
            <div>
              <p>
