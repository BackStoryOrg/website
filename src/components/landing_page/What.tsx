        ...
        <div className="px-6 lg:contents">
          <div className="mx-auto max-w-2xl pb-24 pt-16 sm:pb-32 sm:pt-20 lg:ml-8 lg:mr-0 lg:w-full lg:max-w-lg lg:flex-none lg:pt-32 xl:w-1/2">
            ...
            <div className="mt-10 max-w-xl text-base leading-7 text-gray-700 lg:max-w-none">
              ...
              <p className="mt-8">
                Our bespoke software is perfectly designed for a team of creatives to work collaboratively on a multi-franchise world. Including features such as interactive <b>time-sensitive</b> maps, AI explanations of the world&apos;s lore, and even a pitching system where team members can suggest ideas for new content and discuss them.
              </p>
